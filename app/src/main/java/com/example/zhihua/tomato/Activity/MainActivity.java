...
import com.example.zhihua.tomato.DBHelper.MyDatabaseHelper;
import com.example.zhihua.todolist.R;
import com.example.zhihua.tomato.Adapter.FragmentAdapter;
import com.example.zhihua.tomato.Fragment.ClockFragment;
import com.example.zhihua.tomato.Fragment.TodoFragment;
...
//        初始化fragment，将两个fragment存在viewPager中
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_focus){
            ...
            isFocus.setChecked(getIsFocus(this));//记录专注模式状态，进行持久化保存
    ...
    private void glideLoad(){
        ...
        Glide.with(getApplicationContext())
                .load(SPUtils.get(MainActivity.this, "path" ,""))
                .apply(bitmapTransform(new BlurTransformation(25, 3)))//对图片进行高斯模糊
                .apply(options2)
                .into(nav_bg);
    }
